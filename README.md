...
A TLDR 2 Markdown agent built with Google's Agent Development Kit (ADK)
Agent setup with [`googleCloudPlatform/agent-starter-pack`](https://github.com/GoogleCloudPlatform/agent-starter-pack) version `0.21.0`
...
bq query --use_legacy_sql=false \
  "SELECT * FROM \`tldr2markdown-agent_telemetry.completions\` LIMIT 10"
```
